...
const HomePage = () => {
  ...
  return (
    <div style={{ backgroundColor: 'white' }}> {/* Fixed invalid background-color syntax */}
      <HeroHighlight>
        <motion.h1
          initial={{
            opacity: 0,
          ...
          {[
            {
              ...
              image: 'https://as1.ftcdn.net/v2/jpg/03/28/60/16/1000_F_328601681_7LeMQGIlonbQ9WgYsX3GdzleA6T6ulbr.jpg',
              alt: 'Worker Repairing Refrigerator In House',
            },
            {
              title: 'Washing Machine Repair',
              desc: 'Fixing spin cycle issues, leaks, drainage problems, and more.',
              image: 'https://as2.ftcdn.net/v2/jpg/12/79/63/21/1000_F_1279632143_XQGF8N38Hx0wOTprA81Jw2EZSgn1k92U.jpg',
              alt: 'Technician repairing washing machine in a laundry room with modern equipment for maintenance concept',
            },
            {
              title: 'Oven & Stove Repair',
              desc: 'Repairing heating elements, igniters, temperature controls, and other issues.',
              image: 'https://as1.ftcdn.net/v2/jpg/07/90/74/86/1000_F_790748677_VuALUOsQFDVfN01HeV9YYSQ98KsSJqbo.jpg',
              alt: 'A man is using engineering gestures to repair a stove in a kitchen',
            },
            {
              title: 'Dishwasher Repair',
              desc: 'Fixing drainage problems, leaks, and cleaning performance issues.',
              image: 'https://as1.ftcdn.net/v2/jpg/00/31/15/86/1000_F_31158601_BSA0mxHR9Gns4Wrs4m0d6EmDhGx2lMan.jpg',
              alt: 'Techniker repariert den Geschirrspüler',
            },
          ].map((service, idx) => (
            <motion.div
              key={idx}
